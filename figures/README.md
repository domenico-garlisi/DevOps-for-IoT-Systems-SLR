...
| Fig. 5 | Temporal distribution of the selected papers (2016–2026) | Data-driven bar chart | Regenerate with [`../scripts/generate_fig5_fig6.py`](../scripts/generate-fig.py) from `../data/03-included-studies/primary-studies-template.csv` once populated. **Caption says 122 papers — reconcile against `../docs/known-issues-and-todos.md` first.** |
